...
\begin{algorithm*}
	...
	\Fn{{\sf CheckByFP}($x$, $sa$, $lcp$, $n$)}{
		...
		{\color{blue} sort the tuples in $ST_1$, $ST_2$ and $ST_3$ by the 1st components, respectively;} \label{alg:1:b}
		...
		{\color{blue} sort the tuples in $ST_1'$, $ST_2'$ and $ST_3'$ by the 2nd component, respectively;} \label{alg:1:e}
