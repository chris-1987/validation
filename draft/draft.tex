...
\author{
	Yi~Wu,
	Ge~Nong,~\IEEEmembership{Senior~Member,~IEEE},
	Wai~Hong~Chan,
	Ling~Bo~Han% <-this % stops a space
	\IEEEcompsocitemizethanks{
		\IEEEcompsocthanksitem Y. Wu and G. Nong (corresponding author) are with the Department of Computer Science, Sun Yat-sen University, Guangzhou, and the SYSU-CMU Shunde International Joint Research Institute, Shunde, China. E-mails: wu.yi.christian@gmail.com, issng@mail.sysu.edu.cn.
		...
		\IEEEcompsocthanksitem L.~B.~Han is with the Key Laboratory of Machine Intelligence and Advanced Computing (Sun Yat-sen University), Ministry of Education, China, E-mail: hanlb@mail2.sysu.edu.cn.		
}}% <-this % stops a space
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{ywu_avator.eps}}]{Yi Wu}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{gnong_avatar.eps}}]{Ge Nong}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{chan_avatar.eps}}]{Wai Hong Chan}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{lbhan_avatar.eps}}]{Ling Bo Han}
