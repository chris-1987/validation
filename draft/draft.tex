...
\begin{figure}[htbp!]
	...
	\subfigure{
		...
		\includegraphics[width = 0.95\columnwidth]{pdu_cmp}
	}
	\hfil
	\subfigure{
		\label{subfig:iov_cmp}
		\includegraphics[width = 0.95\columnwidth]{io_cmp}
	}
	\hfil
	\subfigure{
		\label{subfig:ct_cmp}
		\includegraphics[width = 0.95\columnwidth]{ct_cmp}
	}
...
\begin{figure}[htbp!]
	...
	\subfigure{
		...
		\includegraphics[width = 0.95\columnwidth]{pdu_cmp2}
	}
	\hfil
	\subfigure{
		\label{subfig:iov_cmp2}
		\includegraphics[width = 0.95\columnwidth]{io_cmp2}
	}
	\hfil
	\subfigure{
		\label{subfig:ct_cmp2}
		\includegraphics[width = 0.95\columnwidth]{ct_cmp2}
	}
